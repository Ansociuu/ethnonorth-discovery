          ...
          {destinations.map((dest, idx) => (
            ...
            >
              ...
              <div className="md:w-1/2 p-8 flex flex-col justify-between">
                <div>
                  <h2 className="text-3xl mb-4 serif italic leading-tight">{dest.name}</h2>
                  <p className="text-earth-600 text-sm italic font-serif leading-relaxed mb-6">{dest.description}</p>
