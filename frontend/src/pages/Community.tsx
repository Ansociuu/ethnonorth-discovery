        ...
        <div className="bg-earth-950 rounded-sm p-12 md:p-24 text-center text-white space-y-10 relative overflow-hidden">
           <div className="relative z-10 max-w-3xl mx-auto space-y-8">
              ...
              <p className="text-earth-300 text-lg leading-relaxed italic">
                 "Một ngày làm người bản địa" không chỉ là trải nghiệm, đó là sự sẻ chia và thấu hiểu. Hãy cùng chúng tôi xây dựng một cộng đồng du lịch bền vững và có trách nhiệm.
              </p>
